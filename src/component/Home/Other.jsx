...
function Other() {
    return (
        <div className="px-32 py-20">
            <div className=" rounded-2xl flex flex-row h-[540px] mb-20 bg-[#effaf3]">
                <div className="w-1/2 p-8">
                    <img src="/other1.png" />
                </div>
                <div className="w-1/2 p-16 flex flex-col justify-center items-center text-center">
                    <div>
            ...
            <div className=" rounded-2xl flex flex-row h-[540px] mb-20 bg-[#eef7ff]">
                <div className="w-1/2 p-16 flex flex-col justify-center items-center text-center">
                    <div>
                    ...
                    <h1 className="text-5xl font-bold py-5">Bạn muốn cho thuê xe</h1>
            ...
            <div className=" rounded-2xl flex flex-row h-[600px] bg-[#f3f2f2]">
                <div className="w-1/2 p-16 flex flex-col justify-center items-center text-center">
                    <div>
                    ...
                    <h1 className="text-5xl font-bold py-5">Trải nghiệm trọn vẹn
                        cùng ứng dụng Mioto</h1>
