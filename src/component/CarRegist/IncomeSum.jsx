    ...
    return (
        <>
            <div className="px-32 py-10 bg-gray-100">
                <h1 className='text-4xl font-bold text-center'>Thu nhập ước tính của chủ xe</h1>
                <p className="text-md mt-5 text-center px-64">Mioto dựa trên dữ liệu thu nhập bình quân 6 tháng gần nhất của các chủ xe đang kinh doanh hiệu quả trên hệ thống và thống kê theo từng khu vực.</p>
                <table className="w-full border-collapse border border-gray-300 mt-10 rounded-xl text-center font-semibold">
                    <thead>
                        <tr>
                            <th className="border border-gray-300 py-4 px-4 invisible">Cột 1</th>
                            <th className="border border-gray-300 py-4 px-4 text-lg">Thu nhập / tháng</th>
                            <th className="border border-gray-300 py-4 px-4 text-lg">Số ngày cho thuê / tháng</th>
                        </tr>
                    </thead>
                    <tbody>

                        <tr>
                            <td className="border border-gray-300 py-4 px-4">TP.HCM (khu vực trung tâm)</td>
                            <td className="border border-gray-300 py-4 px-4">Từ 5 - 10 triệu</td>
                            <td className="border border-gray-300 py-4 px-4">Từ 6 - 12 ngày</td>
                        </tr>

                        <tr>
                            <td className="border border-gray-300 py-4 px-4">TP.HCM (khu vực ngoại thành)</td>
                            <td className="border border-gray-300 py-4 px-4">3 - 6</td>
                            <td className="border border-gray-300 py-4 px-4">4 - 8</td>
                        </tr>

                        <tr>
                            <td className="border border-gray-300 py-4 px-4">Hà Nội (khu vực trung tâm)</td>
                            <td className="border border-gray-300 py-4 px-4">5 - 8</td>
                            <td className="border border-gray-300 py-4 px-4">6 - 10</td>
                        </tr>

                        <tr>
                            <td className="border border-gray-300 py-4 px-4">Hà Nội (khu vực ngoại thành)</td>
                            <td className="border border-gray-300 py-4 px-4">3 - 6</td>
                            <td className="border border-gray-300 py-4 px-4">4 - 8</td>
                        </tr>

                        <tr>
                            <td className="border border-gray-300 py-4 px-4">Đà Nẵng</td>
                            <td className="border border-gray-300 py-4 px-4">3 - 6</td>
                            <td className="border border-gray-300 py-4 px-4">4 - 8</td>
                        </tr>

                        <tr>
                            <td className="border border-gray-300 py-4 px-4">Bình Dương</td>
                            <td className="border border-gray-300 py-4 px-4">3 - 6</td>
                            <td className="border border-gray-300 py-4 px-4">4 - 8</td>
                        </tr>

                        <tr>
                            <td className="border border-gray-300 py-4 px-4">Đà Lạt</td>
                            <td className="border border-gray-300 py-4 px-4">3 - 6</td>
                            <td className="border border-gray-300 py-4 px-4">4 - 8</td>
                        </tr>

                        <tr>
                            <td className="border border-gray-300 py-4 px-4">Phú Quốc</td>
                            <td className="border border-gray-300 py-4 px-4">3 - 6</td>
                            <td className="border border-gray-300 py-4 px-4">4 - 8</td>
                        </tr>

                        <tr>
                            <td className="border border-gray-300 py-4 px-4">TP khác</td>
                            <td className="border border-gray-300 py-4 px-4">2 - 5</td>
                            <td className="border border-gray-300 py-4 px-4">3 - 6</td>
                        </tr>
                    </tbody>
                </table>
                <p className="text-center text-sm mt-5 text-gray-500 px-64">* Lưu ý: Thu nhập của chủ xe khi cho thuê trên Mioto còn tùy thuộc vào nhiều yếu tố, bao gồm thời gian xe sẵn sàng cho thuê mỗi tháng, mức giá cho thuê và nhu cầu thuê xe ở khu vực của bạn.</p>
            </div>
            <div className="px-32 py-20 border-b border-gray-300">
                <h1 className='text-4xl font-bold text-center'>Ba bước đăng ký xe trên MIOTO</h1>
                ...
                <div className="flex flex-wrap gap-[20px] mt-4">
                    <div className="w-[calc(33.33%-14px)] rounded-xl border-2 border-[#cff1db] bg-[#f7fdf9] p-6 mt-5">
                        <div className="flex flex-col-reverse relative">
                            ...
                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M52.5 17.5V42.5C52.5 50 48.75 55 40 55H20C11.25 55 7.5 50 7.5 42.5V17.5C7.5 10 11.25 5 20 5H40C48.75 5 52.5 10 52.5 17.5Z" stroke="#6AD28E" strokeWidth="4" stroke-miterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path><path d="M36.25 11.25V16.25C36.25 19 38.5 21.25 41.25 21.25H46.25" stroke="#6AD28E" strokeWidth="4" stroke-miterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path><path d="M20 32.5H30" stroke="#6AD28E" strokeWidth="4" stroke-miterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path><path d="M20 42.5H40" stroke="#6AD28E" strokeWidth="4" stroke-miterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                            {/* <img src="/wc1.svg" className="w-full" /> */}
                        </div>
                    </div>
