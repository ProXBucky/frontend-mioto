                ...
                <Form onSubmit={handleSubmit}>
                    <div className="flex w-full flex-row justify-between items-center">
                        <div className="w-5/6">
                            ...
                            <input className="mt-2 border-2 p-2 w-2/3 rounded-md outline-none" type="text" value={title} onChange={(e) => setTitle(e.target.value)} required />
                        </div>
                        <div className='w-1/6 flex flex-col justify-center items-center'>
                            ...
                            <div className="h-24 w-44 border-2">
                                {
                    ...
                    <div className="w-full mt-3">
                        <h3 className="font-semibold text-xl">Nội dung</h3>
