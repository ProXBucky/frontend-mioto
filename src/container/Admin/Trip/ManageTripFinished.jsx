    ...
    return (
        <div className="w-full">
            <div className="flex justify-between">
                <h2 className="font-bold text-xl">Lịch sử chuyến đi</h2>
                                    ...
                                    <div className="w-full flex flex-row" key={index}>
                                        ...
                                        <div className="w-1/6 flex flex-col items-center justify-center">
                                            ...
                                            <div className="h-1/5 w-full flex justify-evenly">
                                                <button className="w-[30%] hover:opacity-80 p-1 px-2 text-sm bg-main text-white font-semibold rounded-md" onClick={() => handleOpenModalView(trip.rentId)}>Xem</button>
                                                <button className="w-[30%] hover:opacity-80 p-1 px-2 text-sm bg-main text-white font-semibold rounded-md" onClick={() => handleDeleteTrip(trip.rentId)}>Xóa</button>
                                            </div>
                                        </div>
                                    </div>
...
export default ManageTripFinished