            ...
            <div className="flex w-full flex-col justify-center items-center mt-10">
                {
                    listMyCar && listMyCar.length > 0 ?
                        listMyCar.map((item, index) => {
                            return (
                                <div className="flex flex-row w-full bg-white p-4 rounded-xl mb-5" key={index}>
                                    <div className="w-2/3 flex flex-col justify-center items-center border-r-2 pr-8">
