                    ...
                    </Button>
                    {
                        modalType !== 'register' && (
                            <>
                                ...
                                <div class="w-full flex justify-between pb-4 mt-2">
                                    <a class="btn btn--s btn-secondary bg-white text-black w-[calc(50%-5px)] rounded-lg flex justify-center items-center gap-2 font-semibold text-sm py-2 border-main">
                                        <div class="wrap-svg">
