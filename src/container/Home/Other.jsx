...
function Other() {
    return (
        <div className="sm:px-3 md:px-5 lg:px-32 py-20">
            <div className=" rounded-2xl flex sm:flex-col md:flex-col lg:flex-row h-auto sm:mb-8 md:mb-20 lg:mb-20 bg-[#effaf3]">
                <div className="sm:w-full md:w-full lg:w-1/2 sm:p-3 md:p-8 lg:p-8 flex justify-center">
                    <img src="/other1.png" />
                </div>
                <div className="sm:w-full md:w-full lg:w-1/2 sm:p-5 md:p-16 lg:p-16 flex flex-col justify-center items-center text-center">
                    <div>
                    ...
                    <h1 className="sm:text-3xl md:text-4xl lg:text-5xl font-bold py-5">Bạn muốn biết thêm về Mioto</h1>
            ...
            <div className=" rounded-2xl flex sm:flex-col md:flex-col lg:flex-row h-auto sm:mb-8 md:mb-20 lg:mb-20 bg-[#eef7ff]">
                <div className="sm:w-full md:w-full lg:w-1/2 sm:p-5 md:p-16 lg:p-16 flex flex-col justify-center items-center text-center">
                    <div>
                    ...
                    <h1 className="sm:text-3xl md:text-4xl lg:text-5xl font-bold py-5">Bạn muốn cho thuê xe</h1>
            ...
            <div className="rounded-2xl flex sm:flex-col md:flex-col lg:flex-row h-auto bg-[#f3f2f2]">
                <div className="sm:w-full md:w-full lg:w-1/2 sm:p-5 md:p-10 lg:p-16 flex flex-col justify-center items-center text-center">
                    <div>
                    ...
                    <h1 className="sm:text-3xl md:text-4xl lg:text-5xl font-bold py-5">Trải nghiệm trọn vẹn cùng ứng dụng Mioto</h1>
                    <div className="flex flex-row gap-2 sm:mt-2 md:mt-3 lg:mt-5">
