...
function Banner({ city, cityName, handleOpenDateModal, handleOpenLocationModal }) {
    ...
    return (
        <div>
            <div className="sm:h-[450px] lg:h-[650px] sm:px-4 md:px-5 lg:px-32">
                <div className="relative w-full sm:h-[450px] lg:h-[600px] rounded-2xl" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: "cover" }}>
                    <div className="w-full h-[500px] flex flex-col sm:pt-4 md:pt-10 lg:pt-32">
                        <div className="w-full text-center sm:pt-10 md:pt-10 lg:py-5 sm:pb-5 md:pb-5 lg:pb-5">
                            {
                                city === "common" ?
                                    <>
                                        <h1 className="font-bold text-white sm:text-3xl md:text-5xl lg:text-6xl">Mioto - Cùng Bạn</h1>
                                        <h1 className="font-bold text-white sm:text-3xl md:text-5xl lg:text-6xl sm:mt-1 md:mt-2 lg:mt-3">Đến Mọi Hành Trình</h1>
                                    </>
                                    :
                                    <>
                                        <h1 className="font-bold text-white sm:text-3xl md:text-5xl lg:text-6xl">Thuê xe tự lái tại</h1>
                                        <h1 className="font-bold text-white sm:text-3xl md:text-5xl lg:text-6xl mt-3"> {location}</h1>
                                    </>
                            }
                        </div>
                        {
                            city === "common" &&
                            <>
                                <div className="border-t-[.5px] border-white sm:w-1/3 md:w-1/4 lg:w-1/5 mx-auto sm:py-1 md:py-2 lg:py-3"></div>
                                <div className="w-full text-center sm:px-4">
                                    <p className="font-semibold text-white sm:text-base md:text-xl lg:text-xl">Trải nghiệm sự khác biệt từ <label className="text-main">hơn 8000</label> xe gia đình đời mới khắp Việt Nam</p>
                                </div>
                            </>

                        }
                        <div className="absolute sm:bottom-[-130px] md:bottom-[-100px] lg:bottom-[-50px] sm:right-[5%] md:right-[5%] lg:right-[17%] sm:w-[90%] md:w-[90%] lg:w-2/3 ">
                            {
                                city === "common" &&
                                <div className="h-14 sm:px-16 md:px-52 lg:px-72">
                                    <div className="rounded-tr-2xl rounded-tl-2xl w-full h-full bg-main flex justify-center items-center">
                                        ...
                                        <p className="text-white font-semibold sm:text-sm md:text-lg lg:text-lg">Xe tự lái</p>
                                    </div>
                                </div>

                            }
                            <div className="sm:h-60 md:h-52 lg:h-32">
                                <div className="bg-white rounded-2xl w-full h-full shadow-xl sm:p-1 md:p-6 lg:p-6">
                                    <div className="h-20 flex sm:flex-col md:flex-col lg:flex-row">
                                        <div className="sm:w-full md:w-full lg:w-2/6 p-2">
                                            <div className="flex flex-row sm:gap-2 md:gap-4 lg:gap-4 items-center mb-2">
                                                ...
                                                <h2 className="sm:text-sm md:text-base lg:text-base text-gray-500">
                                                    Địa điểm
                                                </h2>
                                            </div>
                                            <div className="sm:pl-8 md:pl-10 md:pr-5 lg:pl-10 lg:pr-5 flex flex-row items-center justify-between cursor-pointer" onClick={() => handleOpenLocationModal()}>
                                                <p className="sm:text-base md:text-xl lg:text-xl font-semibold">{location}</p>
                                                <i className="fa-solid fa-chevron-down sm:hidden"></i>
                                            </div>
                                        </div>
                                        <div className="sm:w-full md:w-full lg:w-4/6 p-2 pl-4 flex sm:gap-4 md:gap-0 lg:gap-0 sm:flex-col md:flex-row lg:flex-row justify-between lg:border-l-2">
                                            <div className="sm:w-full md:w-4/5 lg:w-4/5">
                                                <div className="flex flex-row sm:gap-2 md:gap-4 lg:gap-4 mb-2 items-center">
                                                ...
                                                <div className="sm:pl-8 md:pl-10 md:pr-5 lg:pl-10 lg:pr-5 flex flex-row items-center justify-between w-full cursor-pointer" onClick={() => handleOpenDateModal()}>
                                                    <p className="sm:text-base md:text-xl lg:text-xl font-semibold">{beginDate} đến {endDate}</p>
                                                    <i className="fa-solid fa-chevron-down sm:hidden"></i>
                                                </div>
                                            </div>
