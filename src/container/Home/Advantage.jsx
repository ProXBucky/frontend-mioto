    ...
    return (
        <div className="sm:px-3 md:px-5 lg:px-16 xl:px-32 py-20">
            <div className='text-center mb-20'>
                <h1 className='h-12 sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-bold'>Ưu Điểm Của Mioto</h1>
                <h2 className='h-6 sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl font-medium sm:mt-3 md:mt-5 lg:mt-5 xl:mt-5'>Những tính năng giúp bạn dễ dàng hơn khi thuê xe trên Mioto.</h2>
            </div>

            <div className="flex flex-wrap sm:hidden md:gap-6 lg:gap-8 xl:gap-10">
                <div className="flex flex-col items-center md:w-[48%] lg:w-[31%] xl:w-[31%] md:px-5 lg:px-10 xl:px-10">
                    <img src="/advan1.svg" />
