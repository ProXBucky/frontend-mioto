    ...
    return (
        ...
        >
            <Modal.Header className='mt-3 flex justify-between'>
                <i className="fa-regular fa-circle-xmark fa-2xl cursor-pointer invisible" onClick={() => handleCloseModalMap()}></i>
                <h2 className='font-semibold text-2xl text-center'>Bản đồ</h2>
                <i className="fa-regular fa-circle-xmark fa-2xl cursor-pointer" onClick={() => handleCloseModalMap()}></i>
            </Modal.Header>
