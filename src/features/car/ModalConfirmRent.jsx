                    ...
                    <div className='w-2/3 pl-10'>
                        ...
                        <div className="flex flex-col gap-3 mt-2">
                            <div className="flex flex-row gap-3 items-center">
                                ...
                                <div>
                                    <p className="font-semibold text-lg">{car && car.owners && car.owners.user && car.owners.user.fullname}</p>
                            ...
                            <div className='flex items-center'>
                                <p className='font-semibold'>Số điện thoại: {car && car.owners && car.owners.user && car.owners.user.phone}</p>
                            </div>
                        </div>
                    </div>
                </div>
