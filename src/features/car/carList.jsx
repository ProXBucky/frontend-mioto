...
function CarList({ city, isHiddenTitle, carArray }) {
    ...
    return (
        <div className={`px-32 py-10 ${city === "city" ? "" : "bg-gray-100"}`}>
            {
                !isHiddenTitle ?
                    <div className='text-center mb-20'>
                        {
                            city === "city" ?
                                <h1 className='h-12 text-5xl font-bold'>Xe dành cho bạn tại {location}</h1>
                                :
