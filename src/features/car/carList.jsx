...
function CarList({ ava, city, cityName, isHiddenTitle, carArray }) {
    ...
    return (
        <div className={`sm:px-3 md:px-5 lg:px-32 sm:py-28 md:py-14 lg:py-14 ${city === "city" ? "" : "bg-gray-100"}`}>
            {
                !isHiddenTitle ?
                    <div className='text-center sm:mb-6 md:mb-8 lg:mb-20'>
                        {
                            city === "city" ?
                                <h1 className='h-12 sm:text-3xl md:text-4xl lg:text-5xl font-bold'>Xe dành cho bạn tại {cityName}</h1>
                                :
                                <h1 className='h-12 sm:text-3xl md:text-4xl lg:text-5xl font-bold'>Xe Dành Cho Bạn</h1>
            ...
            <div className="flex flex-wrap sm:hidden md:gap-2 lg:gap-3">
                {
                    carArray && carArray.length > 0 ?
                        carArray.map((car, index) => {
                            return (
                                <div className="md:w-[49%] lg:w-[calc(24%)] bg-white p-3 rounded-xl border-2 cursor-pointer" key={index} onClick={() => navigateDetailCar(car.carId)}>
